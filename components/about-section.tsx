...
export function AboutSection() {
  return (
    <section className="scroll-mt-13 md:scroll-mt-16 relative" id="about">
      <div className="absolute inset-0 overflow-hidden">
        <div
          className="absolute size-45 -top-25 -left-20 lg:-top-56 lg:-left-40 lg:size-96 bg-accent/5 rounded-full animate-rotate-glow"
          style={{ animationDelay: "2s" }}
        />
      </div>

      <div className="mx-auto container px-3 md:px-4 pt-5 ">
        {/* Stats Section */}
        <div className="mb-20 grid gap-2 md:gap-6 grid-cols-2 lg:grid-cols-4">
            ...
            {skills.map((skill, index) => {
              ...
              return (
                <GlassCard key={index} index={index}>
                  {/* Icon */}
                  <div
                    className={`mb-4 inline-flex rounded-xl bg-gradient-to-br ${skill.color} p-2 md:p-3 shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6`}
                  >
