...
export const projects: Project[] = [
  ...
  },
  {
    slug: 'reimage',
    title: 'ReImage',
    tagline: 'Professional Image Processing Made Simple',
    description:
      'Convert, compress, and resize images without losing quality. Support for WebP, JPEG, PNG, AVIF, TIFF, and GIF. Built with Sharp.js for production-ready performance.',
    longDescription:
      "ReImage is a powerful image processing SaaS application I built for personal use and decided to release publicly. Born from the frustration of using multiple different sites to accomplish simple image tasks, ReImage consolidates everything into one fast, easy-to-use interface. The app is privacy-focused—it doesn't store any of your data or configurations. Built with Sharp.js for production-grade performance, it's currently a work in progress with plans to expand features over time.",
    type: 'saas',
    featured: true,
    gradient: 'from-purple-500 via-pink-500 to-red-500',
    icon: '🖼️',

    technologies: ['TypeScript', 'React', 'Next.js', 'Sharp.js', 'Tailwind CSS'],

    images: {
      desktop: '/reimage-media/desktop.webp',
      mobile: '/reimage-media/mobile.webp',
      thumbnail: '/reimage-media/desktop.webp',
    },

    links: {
      live: 'https://reimage.mobarut.dev', 
      github: 'https://github.com/Dforrunner/re-image',
    },

    features: [
      'Image format conversion (WebP, JPEG, PNG, AVIF, TIFF, GIF)',
      'Lossless and lossy compression',
      'Batch processing for multiple images',
      'Image resizing with aspect ratio constraints',
      'Metadata preservation options',
      'Before/after comparison viewer',
      '100% client-side processing - no data stored',
      'Fast processing powered by Sharp.js',
      'Intuitive drag-and-drop interface',
    ],

    challenges: [
      'Implementing efficient image processing in the browser while maintaining quality',
      'Handling large files and batch operations without performance degradation',
      'Creating an intuitive UI that simplifies complex image manipulation options',
      'Ensuring privacy by processing everything client-side',
    ],

    results: [
      'All-in-one solution replacing multiple image processing websites',
      'Fast, production-ready performance with Sharp.js',
      'Complete privacy with no server-side data storage',
      'Growing feature set based on real-world usage needs',
    ],

    metaDescription:
      'ReImage - Convert, compress, and resize images with support for WebP, JPEG, PNG, AVIF, TIFF, and GIF. Fast, private, and production-ready image processing.',
  },
];
