...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      {/* Card */}
      <div className="relative h-full overflow-hidden rounded-2xl border border-slate-300 hover:border-slate-400 dark:border-slate-800 dark:hover:border-slate-700 backdrop-blur-sm transition-all duration-500 hover:scale-105 hover:shadow-2xl bg-gradient-primary">
