        ...
        <div className={`transition-all duration-1000 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            {featuredProjects.map((project, index) => (
              <Card
                key={project.id}
                className={`group hover:shadow-xl transition-all duration-300 overflow-hidden hover-lift hover-glow ${
              ...
              >
                ...
                <CardHeader>
                  ...
                  <p className="text-muted-foreground animate-fade-in-left animate-stagger-2">{project.description}</p>
                </CardHeader>
                <CardContent>
          ...
          {otherProjects.length > 0 && (
            <div>
              <h3 className="text-3xl font-bold text-center mb-8 animate-scale-in">Other Projects</h3>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.technologies.map((tech, techIndex) => (
                          <Badge
                            key={techIndex}
                            variant="outline"
                            className={`text-xs animate-bounce-in animate-stagger-${techIndex + 1} hover-lift`}
